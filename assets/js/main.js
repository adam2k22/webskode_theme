(function (window, document, $, undefined) {
    ...
    var webskodeJs = {
        ...
        methods: function (e) {
            webskodeJs.smothScroll();
            webskodeJs.backToTopInit();
            webskodeJs.backToTopInit();
            webskodeJs.counterUpActivation();
            webskodeJs.wowActivation();
            webskodeJs.headerTopActivation();
            webskodeJs.headerSticky();
            webskodeJs.salActive();
            webskodeJs.popupMobileMenu();
            webskodeJs.masonryActivation();
            webskodeJs.magnigyPopup();
            webskodeJs.lightBoxJs();
            webskodeJs.slickSliderActivation();
            webskodeJs.radialProgress();
            webskodeJs.contactForm();
            webskodeJs.menuCurrentLink();
            webskodeJs.onePageNav();
            webskodeJs.darkLight();
        },
        ...
        slickSliderActivation: function () {
            $('.testimonial-activation').not('.slick-initialized').slick({
                ...
                adaptiveHeight: true,
                cssEase: 'linear',
                prevArrow: '<button class="slide-arrow prev-arrow"><span class="color-white material-icons">arrow_back</span></button>',
                nextArrow: '<button class="slide-arrow next-arrow"><span class="color-white material-icons">arrow_forward</span></button>'
            });
